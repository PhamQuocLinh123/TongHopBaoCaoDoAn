...
class StdImage:
    def __init__(self,root):
        ...
        self.root.title("Quản lý ảnh người dùng")
        ...
        right_fr = LabelFrame(root, bd=2, bg="white", relief=RIDGE, text="Thông tin người dùng",
        ...
        #student info
        self.Student_id_label = Label(right_fr, text="ID người dùng:",
        ...
        # name
        self.stdName_label = Label(right_fr, text="Tên người dùng:",
                                          font=("times new roman", 12, "bold"),
                                          bg="white")
        ...
        # class
        self.class_label = Label(right_fr, text="Nghành học:",
                                     font=("times new roman", 12, "bold"),
                                     bg="white")
        ...
        my_cursor.execute(
            "select Student_id,Name,Class from student where Student_id=%s ",
            (value_from_student,))
        ...
        save_btn=Button(right_fr,text="Xóa ảnh",command=self.delete,font=("times new roman",13,"bold"),bg="#000000", fg="white",width=17)
    ...
    def showimg(self, event):
        ...
        self.img_right = self.img_right.resize((220, 220), PIL.Image.BILINEAR)
    ...
    def delete(self):
        ...
        Exit = messagebox.askyesno("Xóa ảnh", "Bạn có chắc chắn muốn xóa ảnh này?", parent=root)
        if (Exit > 0):
            n = self.lst.curselection()
            filename = self.lst.get(n)
            os.remove(filename)
