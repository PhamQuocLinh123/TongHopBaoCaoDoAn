...
class Attendance:
    ...
    def __init__(self,root):
        ...
        main_frame = Frame(bg_img, bd=2, bg="#2528B5")# nằm trong label bg_img, viền xung quanh 2px, bg: mầu nền trắng
        ...
        search_combo = ttk.Combobox(Right_frame, font=("times new roman", 11, "bold"),textvariable=self.var_com_search, state="read only",
                                    width=13)
        search_combo["values"] = ("ID  ", "Ngày", "ID","ID Buổi học")
    ...
    def exportCsv(self):
        try:
            ...
            df = pd.DataFrame(mydata,
                              columns=['Mã ', 'ID', 'Tên', 'Nghành', 'Giờ vào', 'Ngày'])
